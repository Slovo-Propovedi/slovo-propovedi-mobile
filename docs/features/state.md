...
| shared/model      | `src/shared/model/updateInstall.ts`         | `updateStateAtom`, `updateProgressAtom`, `updateErrorAtom`, `updateDialogVisibleAtom`, `startUpdateAction`, `resetUpdateAction`                                                                            | самообновление (in-app)                              |
