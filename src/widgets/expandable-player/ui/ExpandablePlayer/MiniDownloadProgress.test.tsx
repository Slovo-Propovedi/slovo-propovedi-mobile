...
describe('<MiniDownloadProgress>', () => {
  ...
  test('renders the frozen buffered amount when the download failed offline', async () => {
    const ctx = createCtx()
  ...
  test('renders nothing when both download and buffered progress are zero', async () => {
    const ctx = createCtx()
