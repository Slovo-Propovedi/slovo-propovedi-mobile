...
export const CACHING_TITLE = 'Скачивание...'

export const COMPLETION_TITLE = 'Скачивание завершено'

export const ERROR_TITLE = 'Ошибка скачивания'

export const SILENT_CHANNEL_ID = 'playlist-cache-progress'

export const SILENT_CHANNEL_NAME = 'Скачивание плейлиста (прогресс)'

export const ALERT_CHANNEL_ID = 'playlist-cache-alert'

export const ALERT_CHANNEL_NAME = 'Скачивание плейлиста (завершение)'
