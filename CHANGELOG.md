...
- Source API/landing/web/docs hostnames from env vars

### Fixed

- Restamp patches for installed package versions
- Stop orval overwriting hand-written generated index
- Update api generating script
- Remove unused EAS Cloud build tooling
- Silent playlist caching progress notifications, sound only on completion (#101)
...
- Adaptive first-section layout with stacked mode

### Fixed

- Swallow expo-font load timeout rejection
- Wrap long section titles keeping arrow inline

## [0.18.2] - 2026-09-04

### Fixed

- Hide the native-update dialog on web
- Make the cover blur actually blur on Android

## [0.18.1] - 2026-09-04

### Fixed

- Stop continue button from claiming half the row width
- Move continue button after the first section
- Make QR code and URL text open the link on tap
- Add a web app link section
- Drop text from back buttons and unify their icon
- Blur cover artwork behind the header title
